...
void scdepth::bind_downsampler(py::module_& m) {
    ...
    py::class_<Downsampler, std::unique_ptr<Downsampler>>(m, "Downsampler")
        ...
        .def("init", &Downsampler::init, py::arg("prefix"),
             py::arg("mt_prefix") = "", py::arg("mt_file") = "",
             py::arg("mod_file") = "", py::arg("exclude_file") = "",
             py::arg("max_hist") = 50, py::arg("build_matrices") = false,
             py::arg("calc_sau") = false,
             py::call_guard<py::gil_scoped_release>{},
             "Initialize the downsampler from a cached prefix")

        .def("init_visium", &Downsampler::init_visium, py::arg("rows"),
             py::arg("cols"), py::arg("in_tissue"), py::arg("countable"),
             py::arg("total"), py::arg("total_rows"), py::arg("total_cols"),
             py::call_guard<py::gil_scoped_release>{},
             "Initialize the downsampler to create binned tiles/barcodes for "
             "visium HD data")

        .def("downsample", &Downsampler::downsample, py::arg("fracs"),
             py::arg("umi_len"), py::arg("seed"), py::arg("threads") = 1,
        ...
        .def("clear_output", &Downsampler::clear_output,
             py::call_guard<py::gil_scoped_release>{}, "Clear output memory")

        .def("write_gene_mats", &Downsampler::write_gene_mats,
             py::arg("output"), py::arg("idx"), py::arg("bin_div") = 0,
             py::call_guard<py::gil_scoped_release>{},
             "Write the gene detection matrices to a file for comparisons "
             "(optionally bin for visium HD data)")

        .def("write_gene_baseline", &Downsampler::write_gene_baseline,
             py::arg("output"), py::arg("idx"), py::arg("step") = 0,
             py::arg("bin_div") = 0, py::call_guard<py::gil_scoped_release>{},
             "Write the gene detection full count matrix to a file for "
             "comparisons (optionally bin for visium HD data)")
        ...
        // ---------------------------------------------------------------------------
        .def_property_readonly(
            "total_fracs", [](Downsampler& self) { return self.output.steps; },
            "Number of downsampling fractions")

        .def_property_readonly(
            "primer_mode",
            [](Downsampler& self) { return self.output.primer_mode; },
            "Number of downsampling fractions")

        .def_property_readonly(
            "total_barcodes",
            [](Downsampler& self) { return self.output.barcodes; },
            "Number of raw barcodes in the results")

        .def_property_readonly(
            "total_genes", [](Downsampler& self) { return self.output.genes; },
            "Number of genes in the results")

        .def_property_readonly(
            "max_hist", [](Downsampler& self) { return self.output.max_hist; },
            "Maximum histogram bin (histograms have size max_hist+1)")

        .def_property_readonly(
            "samples", [](Downsampler& self) { return self.output.samples; },
            "Number of multiplexed samples")

        .def_property_readonly(
            "seed", [](Downsampler& self) { return self.output.seed; },
            "Downsampling seed")

        .def_property_readonly(
            "build_mats",
            [](Downsampler& self) { return self.output.build_mats; },
            "Whether sparse matrices were built")

        .def_property_readonly(
            "has_MT", [](Downsampler& self) { return self.output.has_mt; },
            "A MT gene list was included")

        .def_property_readonly(
            "has_module", [](Downsampler& self) { return self.output.has_mod; },
            "A module gene list was included")

        .def_property_readonly(
            "has_excluded",
            [](Downsampler& self) { return self.output.has_exc; },
            "An excluded gene list was included")

        .def_property_readonly(
            "has_sau", [](Downsampler& self) { return self.output.calc_sau; },
            "Has spliced/ambig/unspliced quantifications")

        .def_property_readonly(
            "aggregate_only",
            [](Downsampler& self) { return self.output.aggregate_only; },
            "Whether sparse matrices were built")
        ...
        .def_property_readonly(
            "sample_spliced_reads",
            [](Downsampler& self) {
                auto& res = self.output;
                return make_2d_u64(res.spliced.sample_reads, res.samples,
                                   res.steps, py::cast(&self));
            },
            "Multiplexed number of spliced reads (samples x steps)")

        .def_property_readonly(
            "sample_unspliced_reads",
            [](Downsampler& self) {
                auto& res = self.output;
                return make_2d_u64(res.unspliced.sample_reads, res.samples,
                                   res.steps, py::cast(&self));
            },
            "Multiplexed number of unspliced reads (samples x steps)")

        .def_property_readonly(
            "sample_ambiguous_reads",
            [](Downsampler& self) {
                auto& res = self.output;
                return make_2d_u64(res.ambiguous.sample_reads, res.samples,
                                   res.steps, py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) {
                auto& res = self.output;
                return make_2d_u64(res.total.sample_reads, res.samples,
                                   res.steps, py::cast(&self));
            },
            "Multiplexed number of total reads (samples x steps)")

        .def_property_readonly(
            "sample_spliced_molecules",
            [](Downsampler& self) {
                auto& res = self.output;
                return make_2d_u64(res.spliced.sample_molecules, res.samples,
                                   res.steps, py::cast(&self));
            },
            "Multiplexed number of spliced molecules (samples x steps)")

        .def_property_readonly(
            "sample_unspliced_molecules",
            [](Downsampler& self) {
                auto& res = self.output;
                return make_2d_u64(res.unspliced.sample_molecules, res.samples,
                                   res.steps, py::cast(&self));
            },
            "Multiplexed number of unspliced molecules (samples x steps)")

        .def_property_readonly(
            "sample_ambiguous_molecules",
            [](Downsampler& self) {
                auto& res = self.output;
                return make_2d_u64(res.ambiguous.sample_molecules, res.samples,
                                   res.steps, py::cast(&self));
            },
            "Multiplexed number of ambiguous molecules (samples x steps)")

        .def_property_readonly(
            "sample_total_molecules",
            [](Downsampler& self) {
                auto& res = self.output;
                return make_2d_u64(res.total.sample_molecules, res.samples,
                                   res.steps, py::cast(&self));
            },
        ...
        // -----------------------------------------------
        .def_property_readonly(
            "sample_reads_discarded",
            [](Downsampler& self) {
                auto& res = self.output;
                return make_2d_u64(res.sample_reads_discarded, res.samples,
                                   res.steps, py::cast(&self));
            },
            "Multiplexed number of reads lost to ambiguous UMI/gene mappings "
            "(samples x steps)")

        .def_property_readonly(
            "sample_molecules_discarded",
            [](Downsampler& self) {
                auto& res = self.output;
                return make_2d_u64(res.sample_mols_discarded, res.samples,
                                   res.steps, py::cast(&self));
            },
            "Multiplexed number of molecules lost to ambiguous UMI/gene "
            "mappings (samples x steps)")

        .def_property_readonly(
            "sample_reads_excluded",
            [](Downsampler& self) {
                auto& res = self.output;
                return make_2d_u64(res.sample_reads_excluded, res.samples,
                                   res.steps, py::cast(&self));
            },
            "Multiplexed number of reads lost to excluded gene filter (samples "
            "x steps)")
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) -> py::object {
                ...
                auto& res = self.output;
                return make_2d_u32(res.total.bc_reads, res.steps, res.barcodes,
                                   py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) -> py::object {
                ...
                auto& res = self.output;
                return make_2d_u32(res.total.bc_mols, res.steps, res.barcodes,
                                   py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) -> py::object {
                ...
                auto& res = self.output;
                return make_2d_u32(res.total.bc_genes, res.steps, res.barcodes,
                                   py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) -> py::object {
                ...
                auto& res = self.output;
                return make_2d_u32(res.total.bc_mt_mols, res.steps,
                                   res.barcodes, py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) -> py::object {
                ...
                auto& res = self.output;
                return make_2d_u32(res.total.bc_mod_mols, res.steps,
                                   res.barcodes, py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) -> py::object {
                ...
                auto& res = self.output;
                return make_2d_u32(res.spliced.bc_reads, res.steps,
                                   res.barcodes, py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) -> py::object {
                ...
                auto& res = self.output;
                return make_2d_u32(res.spliced.bc_mols, res.steps, res.barcodes,
                                   py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) -> py::object {
                ...
                auto& res = self.output;
                return make_2d_u32(res.spliced.bc_genes, res.steps,
                                   res.barcodes, py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) -> py::object {
                ...
                auto& res = self.output;
                return make_2d_u32(res.spliced.bc_mt_mols, res.steps,
                                   res.barcodes, py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) -> py::object {
                ...
                auto& res = self.output;
                return make_2d_u32(res.spliced.bc_mod_mols, res.steps,
                                   res.barcodes, py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) -> py::object {
                ...
                auto& res = self.output;
                return make_2d_u32(res.unspliced.bc_reads, res.steps,
                                   res.barcodes, py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) -> py::object {
                ...
                auto& res = self.output;
                return make_2d_u32(res.unspliced.bc_mols, res.steps,
                                   res.barcodes, py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) -> py::object {
                ...
                auto& res = self.output;
                return make_2d_u32(res.unspliced.bc_genes, res.steps,
                                   res.barcodes, py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) -> py::object {
                ...
                auto& res = self.output;
                return make_2d_u32(res.unspliced.bc_mt_mols, res.steps,
                                   res.barcodes, py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) -> py::object {
                ...
                auto& res = self.output;
                return make_2d_u32(res.unspliced.bc_mod_mols, res.steps,
                                   res.barcodes, py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) -> py::object {
                ...
                auto& res = self.output;
                return make_2d_u32(res.ambiguous.bc_reads, res.steps,
                                   res.barcodes, py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) -> py::object {
                ...
                auto& res = self.output;
                return make_2d_u32(res.ambiguous.bc_mols, res.steps,
                                   res.barcodes, py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) -> py::object {
                ...
                auto& res = self.output;
                return make_2d_u32(res.ambiguous.bc_genes, res.steps,
                                   res.barcodes, py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) -> py::object {
                ...
                auto& res = self.output;
                return make_2d_u32(res.ambiguous.bc_mt_mols, res.steps,
                                   res.barcodes, py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) -> py::object {
                ...
                auto& res = self.output;
                return make_2d_u32(res.ambiguous.bc_mod_mols, res.steps,
                                   res.barcodes, py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) -> py::object {
                ...
                auto& res = self.output;
                return make_2d_u32(res.bc_dis_reads, res.steps, res.barcodes,
                                   py::cast(&self));
            },
            "Reads lost from multi-gene UMIs and excluded gene lists (steps x "
            "barcodes)")
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) -> py::object {
                ...
                auto& res = self.output;
                return make_2d_u32(res.bc_exc_reads, res.steps, res.barcodes,
                                   py::cast(&self));
            },
            "Reads lost from excluded read lists (steps x barcodes)")

        .def_property_readonly(
            "bc_discarded_moleculess",
            [](Downsampler& self) -> py::object {
                if(self.output.aggregate_only) {
                    return py::none();
                }
                auto& res = self.output;
                return make_2d_u32(res.bc_dis_mols, res.steps, res.barcodes,
                                   py::cast(&self));
            },
        ...
        .def_property_readonly("barcode_mhist",
            ...
            "Histogram of per barcode total reads per molecule (steps x barcodes
        x max_hist)")
        */
        .def_property_readonly(
            "total_mhist",
            [](Downsampler& self) {
                auto& res = self.output;
                return make_2d_u32(res.total.mhist, res.steps, res.max_hist,
                                   py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) {
                auto& res = self.output;
                return make_2d_u32(res.spliced.mhist, res.steps, res.max_hist,
                                   py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) {
                auto& res = self.output;
                return make_2d_u32(res.unspliced.mhist, res.steps, res.max_hist,
                                   py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) {
                auto& res = self.output;
                return make_2d_u32(res.ambiguous.mhist, res.steps, res.max_hist,
                                   py::cast(&self));
            },
        ...
        .def_property_readonly(
            ...
            [](Downsampler& self) {
                ...
                return make_3d_u32(res.total.sample_mhist, res.samples,
                                   res.steps, res.max_hist, py::cast(&self));
            },
            "Histogram of total reads per molecule (samples x steps x "
            "max_hist)")

        .def_property_readonly(
            "sample_spliced_mhists",
            [](Downsampler& self) {
                auto& res = self.output;
                return make_3d_u32(res.spliced.sample_mhist, res.samples,
                                   res.steps, res.max_hist, py::cast(&self));
            },
            "Histogram of spliced reads per molecule (samples x steps x "
            "max_hist)")

        .def_property_readonly(
            "sample_unspliced_mhists",
            [](Downsampler& self) {
                auto& res = self.output;
                return make_3d_u32(res.unspliced.sample_mhist, res.samples,
                                   res.steps, res.max_hist, py::cast(&self));
            },
            "Histogram of unspliced reads per molecule (samples x steps x "
            "max_hist)")

        .def_property_readonly(
            "sample_ambiguous_mhists",
            [](Downsampler& self) {
                auto& res = self.output;
                return make_3d_u32(res.ambiguous.sample_mhist, res.samples,
                                   res.steps, res.max_hist, py::cast(&self));
            },
            "Histogram of ambiguous reads per MT molecule (samples x steps x "
            "max_hist)")
        ...
        .def(
            ...
            [](Downsampler& self, size_t step) {
                ...
                return sparse_to_csr(res.total_mat[step], res.barcodes,
                                     res.genes, py::cast(&self));
            },
            py::arg("step"))
        ...
        .def(
            ...
            [](Downsampler& self, size_t step, uint32_t bin_div) {
                ...
                return sparse_to_csr(res.binned_mat,
                                     ...
                                     res.genes, py::cast(&self), true);
            },
            py::arg("step"), py::arg("bin_div"))
        ...
        .def(
            ...
            [](Downsampler& self, size_t step) {
                ...
                if(step >= res.steps)
                    throw std::out_of_range("step out of range");
                return sparse_to_csr(res.spliced_mat[step], res.barcodes,
                                     res.genes, py::cast(&self));
            },
            py::arg("step"))
        ...
        .def(
            ...
            [](Downsampler& self, size_t step) {
                ...
                if(step >= res.steps)
                    throw std::out_of_range("step out of range");
                return sparse_to_csr(res.ambiguous_mat[step], res.barcodes,
                                     res.genes, py::cast(&self));
            },
            py::arg("step"))
        ...
        .def(
            ...
            [](Downsampler& self, size_t step) {
                ...
                if(step >= res.steps)
                    throw std::out_of_range("step out of range");
                return sparse_to_csr(res.unspliced_mat[step], res.barcodes,
                                     res.genes, py::cast(&self));
            },
            py::arg("step"))
