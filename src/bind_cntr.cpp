...
void scdepth::bind_barcode_counter(py::module_& m) {
    py::class_<BarcodeCounter>(m, "BarcodeCounter",
        "Caches read data from a scRNA-seq sam/bam/cram file")
        .def(py::init<>())

        .def("set_count_parameters",
             &BarcodeCounter::set_count_parameters,
             py::arg("min_gene") = 0.95,
             py::arg("min_gene_bases") = 40u,
             py::arg("min_exonic") = 0.95,
             py::arg("min_intronic") = 15u,
             py::arg("min_qual") = 255,
        ...
        .def("prepare_bam", &BarcodeCounter::prepare_bam,
             py::arg("gtf"), py::arg("bam"), py::arg("out"),
             py::arg("threads") = 1,
        ...
        .def("process_reads", &BarcodeCounter::process_reads,
             py::arg("chunk"),
             py::call_guard<py::gil_scoped_release>{},
        ...
        .def("__repr__", [](const BarcodeCounter&){
